...
png("white_holc_plot.png")
print(white_holc_plot)
dev.off()
...
Research question: Does the history of redlining in the 1930s in metropolitan areas have an impact on the racial composition of those same areas today (2020)?

Based on the graphs created above, we do see a relationship between redlining in the 1930s in metropolitan areas and the racial composition of those same areas today (2020). Neighborhoods with higher HOLC grades in the 30s were "meant for" white families, whereas lower HOLC grades were associated with poor Black families/families of color. When we look at the racial composition of those areas today, we see that the percentage of the population in that area still reflects skewed racial compositions.
